...
//                             <Heading3Fonts className={style.HadingTextSD} text={'Single Filers'} />
//                             <div>
...
//                         </div>
//                         <div className={style.ManiDivForEditInformationFildSD}>
//                             <Heading3Fonts className={style.HadingTextSD} text={'Married Filling Jointly'} />
//                             <div>
//                                 <div className={style.EditMainDivForInputAndLableSectionSD}>
//                                     <div className={style.EditLebulManegeDivSD}>
//                                         <Label>{'Standard Deduction'}</Label>
...
//                         </div>
//                         <div className={style.ManiDivForEditInformationFildSD}>
//                             <Heading3Fonts className={style.HadingTextSD} text={'Married Filing Separately'} />
//                             <div>
//                                 <div className={style.EditMainDivForInputAndLableSectionSD}>
//                                     <div className={style.EditLebulManegeDivSD}>
//                                         <Label>{'Standard Deduction'}</Label>
...
//                         </div>
//                         <div className={style.ManiDivForEditInformationFildSD}>
//                             <Heading3Fonts className={style.HadingTextSD} text={'Head of Household'} />
//                             <div>
//                                 <div className={style.EditMainDivForInputAndLableSectionSD}>
//                                     <div className={style.EditLebulManegeDivSD}>
//                                         <Label>{'Standard Deduction'}</Label>
